...
public class VibratorSettings extends PreferenceFragment implements
    ...
    private static boolean isSupported() {
        ...
        resetButton.setEnabled(fileExists && fileWritable);
        mSeekBar.setEnabled(fileExists && fileWritable);
        mSeekBarValue.setEnabled(fileExists && fileWritable);
    ...
    public static void restoreValue(Context context) {
        ...
        if (DEBUG) Log.d(TAG, "restoreValue " + storedValue);
    }
